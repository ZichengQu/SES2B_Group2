...
<body>
	...
	if(a!=null && b!=null && c!=null && d!=null && e!=null && f!=null){
		...
		String view="select * from session LEFT JOIN advisor ON session.advisorId=advisor.advisorId order by sessionid desc limit 1";
		Statement stm = conn.createStatement();
		ResultSet rs = stm.executeQuery(view);
		while(rs.next()){
			String get_sessionId = rs.getString("sessionId").toString();
			String get_advisorId = rs.getString("advisorId").toString();
			String get_advisorFirstName = rs.getString("firstName").toString();
			String get_advisorLastName = rs.getString("lastName").toString();
			String advisorName = get_advisorFirstName + " " + get_advisorLastName;
