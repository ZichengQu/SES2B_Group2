...
<sql:setDataSource var="myDS" driver="com.mysql.jdbc.Driver" url="jdbc:mysql://aagmqmvaq3h3zl.cvdpbjinsegf.us-east-2.rds.amazonaws.com:3306/uts_help" user="root" password="rootroot"/>
...
<body>
	...
	<div class="wrapper">
		...
		<div class="buttonArea">
			<input type="submit"  value="Archive"  id="archive" onclick="archive()"/>
		</div>
	</div>
